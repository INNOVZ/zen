...
import MCPIntegrationsPage from "@/components/dashboard/integrations/MCPIntegrationsPage";
...
import { MessageSquare, AlertCircle, Plug } from "lucide-react";
      ...
      <div className="container mx-auto p-8 space-y-6">
        ...
        <Tabs defaultValue="mcp" className="w-full">
          ...
          <TabsContent value="messaging" className="space-y-6 mt-6">
            ...
            {/* Placeholder for future messaging integrations */}
