...
ChatWidgetProps) {
  ...
  return (
    ...
    >
      <div
        className={`w-[25vw] flex flex-col shadow-2xl rounded-lg transition-all bg-white m-0 duration-300 ${
          isMinimized ? "h-14" : "h-[70vh]"
        }`}
      >
        <div
          className="flex-row m-3 items-center justify-between space-y-0 p-3 text-white rounded-lg shadow-lg"
          style={{
        ...
        >
          <div className="flex flex-row justify-between items-center gap-5 flex-1">
            <div className="flex flex-row items-center gap-2">
              <div className="w-6 h-6 rounded-full flex flex-row items-center justify-center bg-white/20">
