...
import { PerformanceMetrics } from "@/api/types";
import {
  BarChart3,
  TrendingUp,
  TrendingDown,
...
export default function AnalyticsDashboard({
  ...
  // Render insights
  const renderInsights = (insights: PerformanceMetrics["insights"]) => {
    ...
    <div className="space-y-6 mt-8 border-[#f0f9ff] rounded-2xl">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Performance insights for the last {summary?.period_days || 7} days
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="pointer bg-white p-4 bg-gradient-to-r from-[#dbeafe] via-[#fff] to-white shadow-md border-0 hover:-translate-y-1 duration-500">
            <div>
          ...
          <Card className="pointer bg-white p-4 border-0 hover:-translate-y-1 duration-500">
            <span>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {performance?.satisfaction?.total_feedback || 0} responses
                  </p>
                </div>
        ...
        <div className="flex flex-col gap-4">
          {usage_patterns && (
            <Card className="pointer border-0 hover:scale-[1.02] duration-500">
              <CardHeader>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-3 bg-gray-50 rounded-lg">
                      ...
                      <p className="text-xl font-bold">
                        {formatNumber(usage_patterns.avg_sources_per_query, 1)}
                      </p>
                    </div>
                  </div>
          ...
          <Card className="pointer border-0 hover:scale-[1.02] duration-500">
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <p className="text-gray-500 mb-4">
                  Your analytics will appear here once users start chatting with
                  your bot.
                </p>
