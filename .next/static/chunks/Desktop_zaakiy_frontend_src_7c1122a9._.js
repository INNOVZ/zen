...
"[project]/Desktop/zaakiy/frontend/src/components/auth/LoginForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginForm(param) {
    ...
    const [email, setEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [password, setPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginForm.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$src$2f$app$2f$api$2f$SupabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession().then({
            ...
            const checkAuth = {
                "LoginForm.useEffect.checkAuth": async ()=>{
                    const { data: { session } } = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$src$2f$app$2f$api$2f$SupabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
            ...
            const callBackend = {
                "LoginForm.useEffect.callBackend": async ()=>{
                    ...
                    const token = session === null || session === void 0 ? void 0 : session.access_token;
                    if (!token) return;
                    const backendUrl = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_BACKEND_URL || "http://localhost:8001";
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!email || !password) {
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please enter both email and password");
            return;
        }
        try {
            var _data_user;
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$src$2f$app$2f$api$2f$SupabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email: email,
                password: password
            });
            ...
            if (error) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message);
            } else if ((_data_user = data.user) === null || _data_user === void 0 ? void 0 : _data_user.id) {
                console.log("Login successful, redirecting to dashboard");
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Login successful!");
                // Redirect to user-specific dashboard
                router.replace("/dashboard/".concat(data.user.id));
            } else {
                console.error("No user data received");
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Login failed - no user data received");
            }
        } catch (err) {
            console.error("Login exception:", err);
            __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("An unexpected error occurred during login");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("flex flex-col gap-6", className),
        ...props,
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$zaakiy$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                        href: "#",
...
//# sourceMappingURL=Desktop_zaakiy_frontend_src_7c1122a9._.js.map